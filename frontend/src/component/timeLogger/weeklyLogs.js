...
const Chart = ({data}) => {
    return (
        <LineChart data={data} width={600} height={350} margin={{right: 35}}>
            <Line name={"This week"} dataKey={"thisWeek"} type={"linear"} stroke={"#8340b6"}/>
            <Line name={"Previous week"} dataKey={"prevWeek"} type={"linear"} stroke={"#1DA57A"}/>
